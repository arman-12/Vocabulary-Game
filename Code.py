...
class GameApplication:
    ...
    def create_difficulty_frame(self):
        ...
        beginner_image = PhotoImage(file="beginner_image.png",width= 50)
        ...
        beginner_button = ttk.Button(self.difficulty_frame, command=lambda: self.set_selected_difficulty("Beginner"), image=beginner_image,width=50)
        intermediate_button = ttk.Button(self.difficulty_frame, command=lambda: self.set_selected_difficulty("Intermediate"), image=intermediate_image)
        advanced_button = ttk.Button(self.difficulty_frame, command=lambda: self.set_selected_difficulty("Advanced"), image=advanced_image)
        ...
        # Add a play button
        play_button = ttk.Button(self.difficulty_frame, command=self.start_game,  image=play_image)
